...
/**
 * <p>pushNotify complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="pushNotify"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "pushNotify", propOrder = {
    "senderAccount",
    "recipientAccount",
    "notifyType",
    "message",
...
public class PushNotify {
    ...
    protected PushNotify.ExtraInfo extraInfo;
     ...
     * @return
     *     possible object is
     *     {@link PushNotify.ExtraInfo }
     *     
     */
    public PushNotify.ExtraInfo getExtraInfo() {
        return extraInfo;
    }
     ...
     *     
     */
    public void setExtraInfo(PushNotify.ExtraInfo value) {
    ...
    public static class ExtraInfo {
        ...
        protected List<PushNotify.ExtraInfo.Entry> entry;
         ...
         * {@link PushNotify.ExtraInfo.Entry }
         * 
         * 
         */
        public List<PushNotify.ExtraInfo.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<PushNotify.ExtraInfo.Entry>();
            }
            return this.entry;
        }
